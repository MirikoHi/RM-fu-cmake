...
int main(void)
{
  ...
  uint16_t reset_cntt = 0;
  Board_Order_info[BOARD_NUMBER].Board_Work = 1;
  Board_Order_info[BOARD_NUMBER].Set_Color = BLUE;
  Board_Order_info[BOARD_NUMBER].Twinkle_state = 0;
  Board_Order_info[BOARD_NUMBER].RainBow_Flag = 0;
  Big_Fu_info[BOARD_NUMBER].Color = BLUE;
  Big_Fu_info[BOARD_NUMBER].Last_Color = BLUE;
